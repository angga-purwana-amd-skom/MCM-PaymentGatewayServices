...
class ApiCredential(Base):
    ...
    signature_algorithm = Column(String(50), nullable=False, default="SHA256withRSA")
    token_url = Column(String(255), nullable=False)
    created_at = Column(DateTime, default=func.now())
    updated_at = Column(DateTime, default=func.now(), onupdate=func.now())

    endpoint = relationship("ApiEndpoint", back_populates="credentials")
...
class ApiEndpoint(Base):
    ...
    credentials = relationship("ApiCredential", back_populates="endpoint")
